...
logprint ("Starting VLA_pipe_testgains.py", logfileout='logs/testgains.log')
...
logprint ("Finished VLA_pipe_testgains.py", logfileout='logs/testgains.log')
