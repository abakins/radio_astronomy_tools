...
logprint ("Starting VLA_pipe_finalcals.py", logfileout='logs/finalcals.log')
...
if (QA2_amp=='Fail' or QA2_phase=='Fail'):
    QA2_finalcals='Fail'
elif (QA2_amp=='Partial' or QA2_phase=='Partial'):
    QA2_finalcals='Partial'

logprint ("QA2 score: "+QA2_finalcals, logfileout='logs/finalcals.log')
logprint ("Finished VLA_pipe_finalcals.py", logfileout='logs/finalcals.log')
