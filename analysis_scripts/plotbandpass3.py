...
PLOTBANDPASS_REVISION_STRING = "$Id: plotbandpass3.py,v 1.203 2020/07/26 17:41:40 thunter Exp $" 
import pylab as pb
...
def version(showfile=True):
    ...
    """
    myversion = "$Id: plotbandpass3.py,v 1.203 2020/07/26 17:41:40 thunter Exp $" 
    if (showfile):
